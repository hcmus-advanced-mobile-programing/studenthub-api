...
export class InitDb1711373366152 implements MigrationInterface {
  name = 'InitDb1711373366152';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "experience" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL, "student_id" integer NOT NULL, "title" character varying NOT NULL, "start_month" TIMESTAMP NOT NULL, "end_month" TIMESTAMP NOT NULL, "description" character varying, CONSTRAINT "PK_5e8d5a534100e1b17ee2efa429a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
